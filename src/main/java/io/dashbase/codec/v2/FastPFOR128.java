...
public class FastPFOR128  {
    ...
    public void encodePage(int[] in, IntWrapper inpos, int thissize,
    ...
    public void decodePage(int[] in, IntWrapper inpos, int[] out,
