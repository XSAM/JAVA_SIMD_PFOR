...
public class ForUtil extends BaseForUtil {
    ...
    public void encode(long[] longs, int bitsPerValue, DataOutput out) throws IOException {
        ...
        for (int i = 0; i < numLongsPerShift; ++i) {
            if (i > 60) {
                System.out.println(bitsPerValue + "," + longs.length);
                System.out.println("i=" + i + " shift=" + shift + " idx:" + idx);
            }
     ...
     * generates BinaryPack instructions for it in order to shift multiple longs at once.
     */
    ...
    static void decode7(DataInput in, long[] tmp, long[] longs) throws IOException {
