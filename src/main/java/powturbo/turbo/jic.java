...
package powturbo.turbo;

// See https://github.com/XSAM/TurboPFor-Integer-Compression#java-jni
// This cannot work on M1 Mac. I would recommend to run this on Linux.
public class jic {
    // variable byte
